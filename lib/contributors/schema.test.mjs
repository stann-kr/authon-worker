...
const migration = readFileSync(
  new URL("../../migrations/0020_contributor_analytics_snapshots.sql", import.meta.url),
  "utf8",
);
...
function insertContributor(database, id, venueId, displayName = "Same Name") {
  database.prepare(`
    INSERT INTO venue_contributors (
      id, venue_id, display_name, kind, active, created_at, updated_at
    ) VALUES (?, ?, ?, 'dj', 1, ?, ?)
  `).run(
    id,
    venueId,
