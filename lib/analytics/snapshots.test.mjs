...
test("canonical contributor IDs merge explicit sources and never merge same-name IDs", () => {
  ...
  assert.deepEqual(
    rows.map(({ contributorId, events, registered, checkedIn }) => ({
      contributorId,
      events,
      registered,
      checkedIn,
    ...
    [
      { contributorId: "contributor-b", events: 1, registered: 30, checkedIn: 24 },
      { contributorId: "contributor-a", events: 2, registered: 30, checkedIn: 23 },
    ],
  );
});
