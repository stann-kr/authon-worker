  ...
  return (
    ...
    >
      <summary
        ...
        className={`pressable flex min-h-11 list-none items-center justify-between gap-3 py-2 text-sm font-medium text-text-muted group-open:text-text-heading [&::-webkit-details-marker]:hidden ${
          disabled
